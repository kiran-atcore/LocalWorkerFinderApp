...
class FixDBView(views.APIView):
    permission_classes = [permissions.AllowAny]
    def get(self, request, *args, **kwargs):
        try:
            with connection.cursor() as cursor:
                cursor.execute("""
                ALTER TABLE "users_emailotp" ADD COLUMN IF NOT EXISTS "otp_code" varchar(6) DEFAULT '000000';
                ALTER TABLE "users_emailotp" ADD COLUMN IF NOT EXISTS "attempts" integer DEFAULT 0;
                ...
                CREATE TABLE IF NOT EXISTS "users_review" (
                    ...
                    "friendly_rating" integer NOT NULL,
                    "cost_efficiency_rating" integer NOT NULL,
                    "overall_rating" double precision NOT NULL,
                    "review_text" text NOT NULL,
                    "created_at" timestamp with time zone NOT NULL,
                    "updated_at" timestamp with time zone NOT NULL,
                    "customer_id" bigint NOT NULL REFERENCES "users_customerprofile" ("id") DEFERRABLE INITIALLY DEFERRED,
                    "worker_id" bigint NOT NULL REFERENCES "users_workerprofile" ("id") DEFERRABLE INITIALLY DEFERRED
                );
                
                CREATE TABLE IF NOT EXISTS "users_userdevice" (
                    "id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
                ...
                CREATE TABLE IF NOT EXISTS "users_blockeduser" (
                    "id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
                    "role" varchar(10) NOT NULL,
                    "created_at" timestamp with time zone NOT NULL,
                    "blocked_id" bigint NOT NULL REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED,
                    "blocker_id" bigint NOT NULL REFERENCES "auth_user" ("id") DEFERRABLE INITIALLY DEFERRED
                );
                
                CREATE TABLE IF NOT EXISTS "bookings_jobvacancy" (
                    "id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
                ...
                CREATE TABLE IF NOT EXISTS "bookings_booking" (
                    ...
                    "negotiated_price" numeric(10, 2) NULL,
                    ...
                    "customer_completed" boolean NOT NULL,
                    "worker_completed" boolean NOT NULL,
                    "created_at" timestamp with time zone NOT NULL,
                    "updated_at" timestamp with time zone NOT NULL,
                    "customer_id" bigint NOT NULL REFERENCES "users_customerprofile" ("id") DEFERRABLE INITIALLY DEFERRED,
                    "job_role_id" bigint NOT NULL REFERENCES "services_jobrole" ("id") DEFERRABLE INITIALLY DEFERRED,
                    "worker_id" bigint NOT NULL REFERENCES "users_workerprofile" ("id") DEFERRABLE INITIALLY DEFERRED
                );
                
                CREATE TABLE IF NOT EXISTS "bookings_jobapplication" (
                    "id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
                    "comment" text NOT NULL,
                    "status" varchar(20) NOT NULL,
                    "created_at" timestamp with time zone NOT NULL,
                    "updated_at" timestamp with time zone NOT NULL,
                    "vacancy_id" bigint NOT NULL REFERENCES "bookings_jobvacancy" ("id") DEFERRABLE INITIALLY DEFERRED,
                    "worker_id" bigint NOT NULL REFERENCES "users_workerprofile" ("id") DEFERRABLE INITIALLY DEFERRED
                );
                """)
